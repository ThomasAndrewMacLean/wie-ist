<template>
    <div class="login">
        <h2>Login {{ name }}</h2>
        <GoogleLogin class="google-login" :params="params" :renderParams="renderParams" :onSuccess="onSuccess"
            :onFailure="onFailure">Login</GoogleLogin>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                params: {
                    client_id: "994356706051-p3iqsjg4p12001c50cdecp335ccs82dn.apps.googleusercontent.com"
                },
...
<style scoped>
    ...
    .login {
        background: -webkit-image-set(url("../assets/polaroids2-small.jpg") 1x,
